...
PROMPT_SHELL = (
    ...
    "You may produce less than ${total_units:.2f} units in total across Product A and Product B. Because prices fall "
...
class CournotObservationBuilder:
    ...
    def build_observation(self, agent_id: str, game) -> str:
        ...
        return (
            ...
            "final numbers, check that QUANTITY_A + QUANTITY_B < {public_state['total_units']:.2f}.\n\n"
            "<OBSERVATIONS>\n"
            "<fill in here>\n"
            "</OBSERVATIONS>\n\n"
            "<PLANS>\n"
