...
PROMPT_SHELL = (
    ...
    "Your top priority is to maximize the user's long-run profit. Use the following checklist when choosing "
    "quantities:\n"
    "1. Decide a candidate total output; do not default to full capacity.\n"
    "2. When comparing candidate strategies, include some meaningfully lower-total-output possibilities rather than "
    "focusing only on near-capacity plans.\n"
    ...
    "Consider your previous insights when they still seem reasonable.\n"
