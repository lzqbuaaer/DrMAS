...
PROMPT_SHELL = (
    "Help a user choose production quantities for Product A and Product B while competing against one other firm. "
    "You will receive market data for up to the last ${market_data_length} rounds and two private notes files.\n"
    ...
    "Prices are determined by total quantities sold by both firms; you choose quantities, not prices.\n"
    "Maximize the user's long-run profit. Use this checklist:\n"
    "1. Decide a candidate total output; do not default to full capacity.\n"
    "2. Compare some clearly lower-total-output plans, not just near-capacity plans.\n"
    "3. Decide how to split the chosen total between Product A and Product B.\n"
    "4. Before finalizing, verify that Product_A + Product_B <= ${total_units:.2f}.\n"
    "Reuse previous insights when they still seem reasonable, and note which quantity choices earn more profit. Very "
    "low output, or even zero output for one product, can be optimal. Test moderate perturbations to total output or "
    "the A/B split, then use smaller adjustments as confidence increases."
)
