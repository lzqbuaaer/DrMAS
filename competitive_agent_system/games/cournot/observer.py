...
PROMPT_SHELL = (
    ...
    "Example of a valid quantity choice:\n"
    "<QUANTITY_A>40</QUANTITY_A>\n"
    "<QUANTITY_B>40</QUANTITY_B>\n"
...
class CournotObservationBuilder:
    ...
    def build_observation(self, agent_id: str, game) -> str:
        ...
        return (
            ...
            "<OBSERVATIONS><your analysis></OBSERVATIONS>\n"
            "<PLANS><your plans></PLANS>\n"
            "<INSIGHTS><your insights></INSIGHTS>\n\n"
